...
export const StudentPayments = (props: any) => {
    const { payments, proofs, pixKey, dialogOpenStates, setDialogOpenStates, compressImage, handlePaymentSubmission, loggedInStudent, chatMessages, setChatMessages } = props;
